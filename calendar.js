...
addCalendar("Calendar", "Select Date", "ExpirationDate", "myform");
addCalendar("Calendar1", "Select Date", "mindate", "myform");
addCalendar("Calendar2", "Select Date", "maxdate", "myform");
